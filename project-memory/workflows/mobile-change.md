...
4. **Push scope** — Chat push is implemented for EAS builds; listing/status push is not. If touching chat, run `qa/push-notification-tests.md` and follow `mobile/docs/CHAT_PUSH_SETUP.md`.
