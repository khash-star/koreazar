...
### 0. Facebook Developer Console дээр App ID болон App Secret авах ⚠️

**⚠️ ЭНЭ АЛХМУУДЫГ ОБЯЗАТЕЛЬ ХИЙХ ХЭРЭГТЭЙ! Firebase Console дээр App ID болон App Secret хэрэгтэй.**

1. https://developers.facebook.com/apps руу орох
2. Таны app-ийг сонгох (жишээ: "монгол зарууд")
3. Зүүн sidebar-аас **Settings** → **Basic** руу орох
4. **App ID** олох:
   - "Basic" хуудасны дээд хэсэгт **App ID** харагдана
   - Энэ нь тоонуудын цуваа (жишээ: `1234567890123456`)
   - Энэ утгыг хуулж авах
5. **App Secret** авах:
   - "Basic" хуудасны **App Secret** хэсэгт орох
   - **Show** товчийг дарах
   - App Secret харагдана (жишээ: `abc123def456ghi789jkl012mno345`)
   - **⚠️ ЧУХАЛ:** App Secret зөвхөн нэг удаа харагдана, хэрэв мартвал Reset хийх шаардлагатай
   - Энэ утгыг хуулж авах (хамгийн чухал!)

**📝 Анхааруулга:**
- **Client Token** (`ca4a52c026610aa69cd0f1c39503cc6a` гэх мэт) нь App ID биш! Firebase-д Client Token биш, App ID хэрэгтэй.
- **App ID** нь тоонуудын цуваа (ихэвчлэн 15-17 оронтой)
- **App Secret** нь үсэг, тооны холилт (32 тэмдэгт орчим)
- Эдгээр хоёр утгыг Firebase Console дээр ашиглах ёстой
...
6. Дараах мэдээллийг оруулах (0-р алхмаас авсан утгууд):
   - **App ID**: `YOUR_FACEBOOK_APP_ID` (Facebook Developer Console → Settings → Basic-ээс авсан App ID)
   - **App Secret**: `YOUR_FACEBOOK_APP_SECRET` (Facebook Developer Console → Settings → Basic-ээс авсан App Secret)
