...
**Имэйлээр бүртгүүлэх,нэвтрэх:**
Бүртгүүлэх дээр дарна
Имэйл хаяг, нууц үгээ оруулна
Имэйлээр ирсэн баталгаажуулах линк дээр дарна

🔐 Нэвтрэх
Нэвтрэх дээр дарна
Имэйл, нууц үгээ оруулна
❓ Нууц үгээ мартсан бол
Нууц үгээ мартсан уу? дээр дарна
Имэйл хаягаа оруулна
Имэйлээр ирсэн линкээр шинэ нууц үг үүсгэнэ
        ...
        <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-600 pt-2">
              Солонгос дах Монголчуудын нэгдсэн зарын сайт Та Facebook-с хайж цаг заваа үрэх хэрэггүй, манай сайтаас бүх зар мэдээлэлээ авах боломжтой
            </DialogDescription>
          </DialogHeader>
