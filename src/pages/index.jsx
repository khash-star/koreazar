...
function PagesContent() {
    ...
    return (
        <Routes>
            ...
            <Route path="/mn" element={<LayoutWrapper currentPageName="Home"><Home /></LayoutWrapper>} />
            ...
            <Route path="/AIBot" element={<LayoutWrapper currentPageName={currentPage}><AIBot /></LayoutWrapper>} />
