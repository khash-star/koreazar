/**
 * Admin RBAC — Phase 2 scoped roles (web source of truth).
 * Sync to mobile: npm run sync-admin-roles
 *
 * Roles:
 * - super_admin (legacy alias: admin) — global access (KR + US + all regions)
 * - country_admin + admin_country_code — one country, all active regions
 * - region_admin + admin_region_code — one US region (e.g. washington-dc; chicago later)
 */
