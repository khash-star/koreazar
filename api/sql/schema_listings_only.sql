-- Нэмэлт: зөвхөн listings + listing_images (өмнө нь ads/categories/users гэх мэт өөр хүснэгтүүд аль хэдийн байвал)
-- phpMyAdmin → zarkorea_zarkorea сонгоод SQL табаар ажиллуулна.
